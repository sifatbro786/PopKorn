                        ...
                        <div className="space-y-8">
                            ...
                            <div className="border-l-4 border-[#6556cd] pl-5">
                                ...
                                <p>
                                    ...
                                    collection of films and series. Dive into categories like
                            ...
                            <div className="border-l-4 border-[#6556cd] pl-5">
                                ...
                                <p>
                                    Get real-time updates about what's trending, upcoming releases,
                                    and what's hot in the world of cinema — all in one place.
                                </p>
                            </div>
                        </div>
